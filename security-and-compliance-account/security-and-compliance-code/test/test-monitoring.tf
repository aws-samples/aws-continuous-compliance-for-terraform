...
resource "aws_cloudwatch_metric_alarm" "tf-example-HealthyHostCount-alarm" {
  ...
  dimensions = {
    TargetGroup  = "arn:aws:elasticloadbalancing:us-east-1:111111111111:targetgroup/f78ac2426e59660e"
    LoadBalancer = "arn:aws:elasticloadbalancing:us-east-1:111111111111:loadbalancer/app/bibuiwbe770"
  }
  tags = {
